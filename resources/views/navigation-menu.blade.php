        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('dashboard.movie.index') }}" :active="request()->routeIs([
                        'dashboard.genre.index',
                    ...
                    <x-nav-link href="{{ route('dashboard.singer.index') }}" :active="request()->routeIs('dashboard.singer.index')">
                        {{ __('Music') }}
                    </x-nav-link>
                </div>
            </div>
